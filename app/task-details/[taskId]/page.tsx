...
// 1. Importation dynamique de ReactQuill sans SSR
...
const page = ({ params }: { params: Promise<{ taskId: string }> }) => {
  ...
  // 2. Astuce bonus : Utiliser useMemo pour les modules empêche ReactQuill 
  // de perdre le focus à chaque re-rendu du composant.
