-- CreateEnum
CREATE TYPE "Role" AS ENUM ('STAGIAIRE', 'ADMIN');
...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_validatedById_fkey" FOREIGN KEY ("validatedById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
